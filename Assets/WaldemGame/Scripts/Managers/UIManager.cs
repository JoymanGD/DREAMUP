...
{    
    ...
    #pragma warning disable 0649
        ...
        private HUD MenuHUD;
        [SerializeField]
        private TextMeshProUGUI playerTipText;
    ...
    #pragma warning restore 0649
        ...
        public void ShowPlayerTip(string text)
        {
            playerTipText.gameObject.SetActive(true);
            playerTipText.text = text;
        }

        public void HidePlayerTip()
        {
            playerTipText.gameObject.SetActive(false);
            playerTipText.text = "";
        }
